        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('orders.update1', ['id'=> $order->id]) }}" role="form">
                            @csrf
                                ...
                                <div class="form-group{{ $errors->has('products') ? ' has-error' : '' }}">
                                    ...
                                    <select id="productos" class="form-control">
                                        ...
                                        @foreach ($products as $product)
                                            <option
                                                value="{{ $product->id }}_{{ $product->name }}_{{ $product->price }}_{{ $product->stock }}">
                                                {{ $product->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" class="form-control" id="total" name="amount"
                                                value="0" readonly>
...
@section('js')
    <script>
        ...
        $(document).ready(function () {
           $.ajax({
            url: "{{ route('orders.list.product', 'id') }}".replace('id', {{ $order->id }}),
            type: "get",
